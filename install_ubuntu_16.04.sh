...
wget https://github.com/bulwark-crypto/Bulwark/releases/download/1.2.1.0/bulwark-1.2.1.0-x86_64-ubuntu16.04-gnu.tar.gz
sudo tar -xzvf bulwark-1.2.1.0-x86_64-ubuntu16.04-gnu.tar.gz
sudo rm bulwark-1.2.1.0-x86_64-ubuntu16.04-gnu.tar.gz
